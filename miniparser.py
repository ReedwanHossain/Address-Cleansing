...
roadkeywords=['road' , 'ave' , 'lane' , 'sarani' , 'sharani', 'soroni', 'shoroni' , 'rd#' , 'sarak' , 'sharak' , 'shorok' , 'sharani' , 'highway' , 'path' , 'poth' , 'chowrasta' , 'sarak' , 'rasta' , 'sorok' , 'goli' , 'street' , 'line']
